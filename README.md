...
<table align="center" border="1" width="95%" style="text-align:center;">
    ...
    <tr align="left">
        <td><b>Sprint 2</b> <br><b>Review Summary</b></td>
        <td>
    ...
    <tr align="left">
        <td><b>Sprint 2</b> <br><b>Retrospective Summary</b></td>
        <td>
...
Esta matriz resume los roles de liderazgo (L) y colaboración (C) asumidos por los integrantes del equipo FinTeka durante el Sprint 4. La asignación se realizó en función de la experiencia técnica y las responsabilidades asumidas por cada miembro en actividades clave como el despliegue y mejora del frontend y backend, la gestión de perfiles y la documentación final del proyecto. Esta distribución permitió consolidar el producto para su entrega final, asegurando eficiencia y coordinación en el trabajo colaborativo.

| Team Member                   | Github Username | Sprint 4 |  Despliegue del Frontend | Despliegue del Backend | Profiles | Documentación |
|------------------------------|-----------------|----------|--------------------------------------------|--------------------|---------------|----------------|
| Mendoza Solis Javier Kenyi   | Kenyi-Mendoza-Solis| L     |                      C                    | C                  | C             | C               |
| Oshiro Yamashita Daiki Oscar | DaikiOY         | C        |                      C                    | C                  | C             | L               |
| Aguirre Castillo Sergio Cesar| Aguirrat157     | C        |                      C                    | C                  | L             | C               |
| Romero Qwistgaard Russel Stephen | RussellUPC  | C        |                      C                    | L                  | C             | C               |
| Chamorro Acero, Salvador Edward | SALVA1704  | L        |                      C                    | C                  | C               | C               |  
...
Asimismo, se actualizó la información de la landing page con los datos actuales del equipo y se aplicaron mejoras estéticas para preparar la plataforma de cara a su versión final. 
