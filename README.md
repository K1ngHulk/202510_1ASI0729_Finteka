...
|------------------------------------------|--------------------------------------|-------------|------------------------------------------|-------------------------------------------|---------------------------------------------------------|
| /sessions                                | Crear sesión                         | POST        | /sessions                                | Body: detalles de sesión                  | localhost:8080/swagger-ui/index.html            |
| /sessions/reserve                        | Reservar una sesión                  | POST        | /sessions/reserve                        | Body: id_sesión, id_usuario               | localhost:8080/swagger-ui/index.html            |
| /sessions/available                      | Consultar sesiones disponibles       | GET         | /sessions/available                      | Query: fecha, id_profesional              | localhost:8080/swagger-ui/index.html            |
| /profiles                                | Crear perfil                         | POST        | /profiles                                | Body: datos del perfil                    | localhost:8080/swagger-ui/index.html            |
| /profiles                                | Obtener todos los perfiles           | GET         | /profiles                                | Ninguno                                   | localhost:8080/swagger-ui/index.html            |
| /profiles/{id}                           | Obtener perfil por ID                | GET         | /profiles/{id}                           | Path: id                                  | localhost:8080/swagger-ui/index.html            |
| /profiles/{id}                           | Actualizar perfil                    | PUT         | /profiles/{id}                           | Path: id, Body: datos del perfil          | localhost:8080/swagger-ui/index.html            |
| /profiles/{id}                           | Eliminar perfil                      | DELETE      | /profiles/{id}                           | Path: id                                  | localhost:8080/swagger-ui/index.html            |
| /api/notificaciones                      | Consultar notificaciones             | GET         | /api/notificaciones                      | Ninguno                                   | localhost:8080/swagger-ui/index.html            |
| /api/notificaciones                      | Crear notificación                   | POST        | /api/notificaciones                      | Body: profesionalId, título, mensaje      | localhost:8080/swagger-ui/index.html            |
| /api/notificaciones/{id}/read            | Marcar notificación como leída       | POST        | /api/notificaciones/{id}/read            | Path: id                                  | localhost:8080/swagger-ui/index.html            |
