...
| <div style="display: flex; align-items: center;"><img src="img/Kenyi-Mendoza.png" alt="Kenyi" width="100" height="150">&nbsp;&nbsp;<br>**Javier Kenyi Mendoza Solis**<br>u201824550</div> | Estudio la carrera de ingeniería de software. Crear programas en entornos distintos para poder ampliar mi conocimiento es de las cosas que me apaasionan. | He aprendido a programar en lenguajes como HTML, C++, Java, SQL y Python |
